      ...
      <header>
        <div className="h-15 w-full ">
          ...
          <div className="flex justify-between h-full">
            ...
            <a className="h-full border border-transparent pl-1 pr-2 hover:border-white "href=""><span className="flex items-center w-full h-full hover:translate-y-0.5">Today's Deals</span></a>
            <a className="h-full border border-transparent pl-1 pr-2 hover:border-white "href=""><span className="flex items-center w-full h-full hover:translate-y-0.5">Registry</span></a>
            <a className="h-full border border-transparent pl-1 pr-2 hover:border-white " href=""><span className="flex items-center w-full h-full hover:translate-y-0.5">Customer Service</span></a>
            <a className="h-full border border-transparent pl-1 pr-2 hover:border-white " href=""><span className="flex items-center w-full h-full hover:translate-y-0.5">Gift Cards</span></a>
            <a className="h-full border border-transparent pl-1 pr-2 hover:border-white " href=""><span className="flex items-center w-full h-full hover:translate-y-0.5">Sell</span></a>
            </div>
